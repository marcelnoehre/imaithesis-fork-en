...
\newglossaryentry{anwendungssystem}{
  name=Anwendung,
  description={Softwaresystem, mit dem Aufgaben bearbeitet werden}
  }
\newglossaryentry{applikation}{
  name=Applikation,
  description={\textit{Anwendung}}
  }
\newglossaryentry{wizard}{
  name=Wizard,
  description={Assistent, der eine Benutzungsschnittstelle zur einfachen Kon\-fig\-uration (z.B.\ zur Softwareinstallation) oder auch als Hilfe beim Ausfüllen von Formularen bereitstellt}
  }
